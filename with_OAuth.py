...
Wees consisten in de namen bijvoorbeeld: LOT of LOT airlines is altijd LOT, KLM airlines is gewoon KLM, NMBS,... .
...
EXTREEM BELANGRIJK: Geef alleen geldige JSON terug, zonder enige toelichting of tekst errond. Als iets niet in JSON staat krijg ik een error in mijn code.
